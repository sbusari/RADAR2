	...
	*/
	public int[] getValue(int index) throws JMException {
		  if ((index >= 0) && (index < size_))
			  ...
			  Configuration.logger_.severe(jmetal.encodings.variable.ArrayBitVector.class+".getValue(): index value (" + index + ") invalid");
			  throw new JMException(jmetal.encodings.variable.ArrayBitVector.class+": index value (" + index + ") invalid") ;
		  } // if
	} // getValue
	...
	*/
	public void setValue(int index, int [] value) throws JMException {
		if ((index >= 0) && (index < size_))
		 ...
		 Configuration.logger_.severe(jmetal.encodings.variable.ArrayBitVector.class+".setValue(): index value (" + index + ") invalid");
		 throw new JMException(jmetal.encodings.variable.ArrayBitVector.class+": index value (" + index + ") invalid") ;
		} // else
	} // setValue
	...
	public int getMultipleValue(int indexI, int indexJ) throws JMException {
		...
		if ((indexI >= 0) && (indexI < decisionPoints_) && (indexJ >= 0) && (indexJ < options_) ){
		 ...
		 Configuration.logger_.severe(jmetal.encodings.variable.ArrayBitVector.class+".getMultipleValue(): index value (" + indexI + ") invalid");
		 throw new JMException(jmetal.encodings.variable.ArrayBitVector.class+": index value (" + indexI + ") invalid") ;
		} // else
	...
	public void setMultipleValue(int indexI, int indexJ, int value) throws JMException {
		if ((indexI >= 0) && (indexI < decisionPoints_)){
		 ...
		 Configuration.logger_.severe(jmetal.encodings.variable.ArrayBitVector.class+".setMultipleValue(): index value (" + indexI + ") invalid");
		 throw new JMException(jmetal.encodings.variable.ArrayBitVector.class+": index value (" + indexI + ") invalid") ;
		} // else
	} // setValue
	...
	public double getLowerBound(int index) throws JMException {
		if ((index >= 0) && (index < size_))
			...
			Configuration.logger_.severe(jmetal.encodings.variable.ArrayBitVector.class+".getLowerBound(): index value (" + index + ") invalid");
			throw new JMException(jmetal.encodings.variable.ArrayBitVector.class+".getLowerBound: index value (" + index + ") invalid") ;
		} // else	
	} // getLowerBound
	...
	public double getUpperBound(int index) throws JMException {
		if ((index >= 0) && (index < size_))
			...
			Configuration.logger_.severe(jmetal.encodings.variable.ArrayBitVector.class+".getUpperBound(): index value (" + index + ") invalid");
			throw new JMException(jmetal.encodings.variable.ArrayBitVector.class+".getUpperBound: index value (" + index + ") invalid") ;
		} // else
	} // getLowerBound
