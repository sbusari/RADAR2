...
public class InputValidator {
	...
	public static void validateSbseParameters (boolean defaultAlgorithmParameter,List<String> solve,List<String> algorithmParameter ) throws Exception{
		if (solve != null && !solve.contains("ExhaustiveSearch") && algorithmParameter.size() <= 0 && defaultAlgorithmParameter == false ){
		...
		if (solve != null && solve.contains("ExhaustiveSearch") && ( algorithmParameter.size() > 0 || defaultAlgorithmParameter == true )){
	...
	public static void validateSolveNotNull (List<String> solve) throws Exception{
		if (solve != null && !solve.contains("ExhaustiveSearch") && !solve.contains("NSGAII") &&  !solve.contains("SPEA2") &&  !solve.contains("IBEA") &&  !solve.contains("MoCell") &&  !solve.contains("PAES") &&  !solve.contains("RandomSearch")){
