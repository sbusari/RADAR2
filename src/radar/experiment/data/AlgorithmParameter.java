...
public class AlgorithmParameter {
	...
	public AlgorithmParameter(Parser parserEngine, ExperiementData expData){
		...
		this.mutationProbability_ = expData.getUseDefaultParameterSettings() == true? (double)1/Helper.getTotalOptions(parserEngine.getSemanticModel()):expData.getMutationProbability() ;
	...
	public AlgorithmParameter getParameterSettings (Parser parserEngine){
		...
		param.mutationProbability_ = useDefaultParameter == true? (double)1/Helper.getTotalOptions(parserEngine.getSemanticModel()):ConfigSetting.MUTATION ;
