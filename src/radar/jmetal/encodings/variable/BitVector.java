 ...
 */
public class BitVector extends Variable {
	 ...
	 */
	public BitVector(int lowerBound, int upperBound){
	 ...
	 * @param upperBound Variable upper bound
	 */
	public BitVector(int value, int lowerBound, int upperBound) {
		super();
	 ...
	 * @throws JMException 
	 */
	public BitVector(Variable variable) throws JMException{
