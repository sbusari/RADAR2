...
public class Spread {
  ...
  public static radar.jmetal.qualityIndicator.MetricsUtil utils_;//utils_ is used to access to 
  ...
  public double spread(double [][] front, 
    ...
    Arrays.sort(normalizedFront,
    		    new radar.jmetal.qualityIndicator.LexicoGraphicalComparator());
