...
public class MetricsUtil {
  ...
  /**
	 ...
	 * @return A solution set
	 */
	public void readExactNonDominatedSolutionSet(String path, NonDominatedSolutionList solutionSet, OptimisationType optType) {
		try {
			/* Open the file */
			FileInputStream fis   = new FileInputStream(path)     ;
			InputStreamReader isr = new InputStreamReader(fis)    ;
			...
			while (aux!= null) {
				...
				solutionSet.addExactSolution(solution);
	 ...
	 * @return A solution set
	 */
	public void readNonDominatedSolutionSet(String path, NonDominatedSolutionList solutionSet, OptimisationType optType) {
		try {
			/* Open the file */
			FileInputStream fis   = new FileInputStream(path)     ;
			InputStreamReader isr = new InputStreamReader(fis)    ;
	...
	/**
	 * Reads a set of decision vectors of a non dominated solutions from a file
	 * and store it in a existing non dominated solution set
	 * @param path The path of the file containing the data
	 * @return A solution set
	 */
	public void solutionSet(String path, int noOfObj, NonDominatedSolutionList solutionSet) {
	    try {
	      /* Open the file */
	      FileInputStream fis   = new FileInputStream(path)     ;
	      InputStreamReader isr = new InputStreamReader(fis)    ;
	      ...
	      String aux = br.readLine();
	      while (aux!= null) {
	    	  Solution solution = new Solution(noOfObj,aux);
	    	  solutionSet.addSolutionForDecisionVectorUnique(solution);
	          aux = br.readLine();
	      }
	      br.close();
	   
	    } catch (Exception e) {
	      System.out.println("jmetal.qualityIndicator.util.decisionVectorString: "+path);
	      e.printStackTrace();
	    }
	 ...
	 * @return A solution set
	 */
	public void readExactNonDominatedSolutionSetString(String path, int noOfObj, NonDominatedSolutionList solutionSet) {
	    try {
	      /* Open the file */
	      FileInputStream fis   = new FileInputStream(path)     ;
	      InputStreamReader isr = new InputStreamReader(fis)    ;
	 ...
	 * @return A solution set
	 */
	public void readNonDominatedSolutionSetString(String path, int noOfObj, NonDominatedSolutionList solutionSet) {
	    try {
	      /* Open the file */
	      FileInputStream fis   = new FileInputStream(path)     ;
	      InputStreamReader isr = new InputStreamReader(fis)    ;
	      ...
	      while (aux!= null) {
	    	  Solution solution = new Solution(noOfObj,aux);
	    	  solutionSet.addSolutionForDecisionVector(solution);
	          aux = br.readLine();
	      }
	      br.close();
	 ...
	 * @return A solution set
	 */
	public void readAllSolutionSet(String path, int noOfObj, NonDominatedSolutionList solutionSet) {
	    try {
	      /* Open the file */
	      FileInputStream fis   = new FileInputStream(path)     ;
	      InputStreamReader isr = new InputStreamReader(fis)    ;
