...
public class GeneralizedSpread {
  ...
  public static radar.jmetal.qualityIndicator.MetricsUtil utils_;  // MetricsUtil provides some 
  ...
  public double generalizedSpread(double [][] paretoFront,
    ...
    for (int i = 0; i < numberOfObjectives; i++) {
      Arrays.sort(normalizedParetoFront,new radar.jmetal.qualityIndicator.ValueComparator(i));
    ...
    Arrays.sort(normalizedFront,new radar.jmetal.qualityIndicator.LexicoGraphicalComparator());
