...
public class SPEA2_Settings extends Settings {
   ...
   * Constructor
   */
  public SPEA2_Settings(String problem,DecisionVectorType typeOfDecisonVector) {
	...
	public SPEA2_Settings(String problemName, String solutionType,
...
/**
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new SPEA2(problem_,parserEngine_,alternativesObjectiveAndDecisionsPath_) ;
  ...
  public Algorithm configure(Properties configuration) throws JMException {
    ...
    parameters.put("probability", crossoverProbability_) ;
    parameters.put("distributionIndex", crossoverDistributionIndex_) ;
    crossover = CrossoverFactory.getCrossoverOperator("SBXCrossover", parameters,typeOfDecisonVector_);
    ...
    parameters.put("probability", mutationProbability_) ;
    parameters.put("distributionIndex", mutationDistributionIndex_) ;
    mutation = MutationFactory.getMutationOperator("PolynomialMutation", parameters,typeOfDecisonVector_);
