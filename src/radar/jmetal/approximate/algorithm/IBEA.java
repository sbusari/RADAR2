...
public class IBEA extends Algorithm{
  ...
  */
   ...
   * @param problem Problem to solve
   */
   public IBEA(Problem problem, Parser parserEngine) {
     super (problem) ;
     parserEngine_= parserEngine;
   } //  IBEA
   public IBEA(Problem problem, Parser parserEngine,String alternativesObjectiveAndDecisionsPath) {
	     super (problem) ;
	     parserEngine_= parserEngine;
  ...
  * @throws JMException
  */
  public synchronized SolutionDetail execute() throws JMException, ClassNotFoundException{
    ...
    if (evaluations >= maxEvaluations){
	    ...
	    /*if (parserEngine_.getDecisionModel().getDecisionVectorBlock().getDecisionVectorType() == DecisionVectorType.Decision){
		   	new Helper().printAlternativesObjectivesAndDecisions(solutionSet,alternativesObjectiveAndDecisionsPath_,"IBEA");
	   }else if (parserEngine_.getDecisionModel().getDecisionVectorBlock().getDecisionVectorType() == DecisionVectorType.DecisionSubset){
	   		new Helper().printAlternativesObjectivesAndDecisionSubsets(solutionSet,alternativesObjectiveAndDecisionsPath_,"IBEA");
	   }else{
    ...
    while (evaluations < maxEvaluations){
      ...
      while (offSpringSolutionSet.size() < populationSize){
        ...
        evaluations++;
        System.out.println ("============================");
        System.out.println ("evaluation for IBEA is  "+ evaluations);
      } // while
      // End Create a offSpring solutionSet
      solutionSet = offSpringSolutionSet;
      
      /*if (parserEngine_.getDecisionModel().getDecisionVectorBlock().getDecisionVectorType() == DecisionVectorType.Decision){
  	   	new Helper().printAlternativesObjectivesAndDecisions(offSpringSolutionSet,alternativesObjectiveAndDecisionsPath_,"IBEA");
     }else if (parserEngine_.getDecisionModel().getDecisionVectorBlock().getDecisionVectorType() == DecisionVectorType.DecisionSubset){
     		new Helper().printAlternativesObjectivesAndDecisionSubsets(offSpringSolutionSet,alternativesObjectiveAndDecisionsPath_,"IBEA");
     }else{
