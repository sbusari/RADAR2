...
public class NSGAII_Settings extends Settings {
   ...
   * Constructor
   */
  public NSGAII_Settings(String problem,DecisionVectorType typeOfDecisonVector) {
	...
	public NSGAII_Settings(String problemName, String solutionType,
...
/**
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new NSGAII(problem_,parserEngine_,alternativesObjectiveAndDecisionsPath_) ;
  ...
  */
  ...
  public Algorithm configure(Properties configuration) throws JMException {
    ...
    parameters.put("probability", crossoverProbability_) ;
    parameters.put("distributionIndex", crossoverDistributionIndex_) ;
    crossover = CrossoverFactory.getCrossoverOperator("GModelSinglePointCrossover", parameters,typeOfDecisonVector_);
    ...
    parameters.put("probability", mutationProbability_) ;
    parameters.put("distributionIndex", mutationDistributionIndex_) ;
    mutation = MutationFactory.getMutationOperator("GModelBitFlipMutation", parameters,typeOfDecisonVector_);
