...
public class CrossoverFactory {
   ...
   * @return The operator
   */
  public static Crossover getCrossoverOperator(String name, HashMap parameters,DecisionVectorType typeOfDecisionVector) throws JMException {  
    if (name.equalsIgnoreCase("SinglePointCrossover"))
        return new SinglePointCrossover(parameters,typeOfDecisionVector);
    else {
