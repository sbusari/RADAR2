...
public class MutationFactory {
   ...
   * @throws JMException 
   */
  public static Mutation getMutationOperator(String name, HashMap parameters,DecisionVectorType typeOfDecisionVector) throws JMException{
 
    
    if (name.equalsIgnoreCase("BitFlipMutation"))
        return new BitFlipMutation(parameters,typeOfDecisionVector);    
    else
    {
