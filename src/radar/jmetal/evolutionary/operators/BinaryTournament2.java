...
public class BinaryTournament2 extends Selection {
  ...
  */
  public Object execute(Object object)    
  {
    ...
    {
      a_= (new radar.jmetal.util.PermutationUtility()).intPermutation(population.size());
    }
            
        
    Solution solution1 =null;Solution solution2 =null;
	
    /*try {
    	solution1 = (Solution)population.get(a_[index_]).clone();
    	solution2  = (Solution)population.get(a_[index_+1]).clone();
	} catch (CloneNotSupportedException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}*/
    
    // comment this part cos it was eating a lot of memory..

  /*  if (population.size() >= 2){
    	 solution1 = (Solution)Solution.deepClone(population.get(a_[index_]));
    	 solution2 = (Solution)Solution.deepClone(population.get(a_[index_+1]));
    }else{
    	solution1 = (Solution)Solution.deepClone(population.get(PseudoRandom.randInt(0,population.size()-1)));
        solution2 = (Solution)Solution.deepClone(population.get(PseudoRandom.randInt(0,population.size()-1)));
    }*/
    
    
    	try {
    		if (population.size() >= 2){
    	    	solution1 =  new Solution( population.get(a_[index_]));
    	        solution2 = new Solution (population.get(a_[index_+1]));
    	    }else{
    	    	solution1 =  new Solution(population.get(PseudoRandom.randInt(0,population.size()-1)));
    	    	solution2 = new Solution(population.get(PseudoRandom.randInt(0,population.size()-1)));
    	    }
