...
public class SolutionSet implements Serializable {
  ...
  */
   ...
   * @param path The output file name
   */
  public void printOptimalObjectivesToFile(String path){
    try {
      /* Open the file */
 ...
 * @throws JMException 
  ...
  public Parser getParserEngne (){
	  return parserEngine_;
  }
  public void setParserEngne (Parser parserEngine){
