...
public abstract class Problem implements Serializable {
  ...
  /**
   * Stores the decisions and corresponding selected option.
   */
  protected  Map<String, Decision>  decisions_;
  //protected  LinkedHashMap<String, ArrayList<String>>  decisionOptions_;
  /**
   * Stores index of selected options for all alternatives.
   */
 protected ArrayList<Integer[]> allAlternativeIndices_;
 /**
  * Stores the parser engine
  */
 protected Parser parserEngine_;
  ...
  public void setDecisionOptions(Map<String, Decision>  decisions) {
  ...
  public void setAllAlternativeIndices(ArrayList<Integer[]> allAlternativeIndices) {
	  allAlternativeIndices_ = allAlternativeIndices;  
  }// setAllAlternativeIndices 
  
  public  ArrayList<Integer[]> getAllAlternativeIndices() {
	    return allAlternativeIndices_ ;   
  } // setAllAlternativeIndices
  
  public void setParserEngine(Parser parserEngine) {
	  parserEngine_ = parserEngine;  
  }// setAllAlternativeIndices 
  
  public Parser getParserEngine() {
