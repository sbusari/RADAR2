...
public abstract class SolutionType {	
   ...
   */
	...
	/**
	   * Abstract method to create the Radar decision variables of the solution
	   */
	public abstract List<Variable[]> createArrayBitVectorVariables() throws ClassNotFoundException ;
