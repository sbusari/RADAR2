...
public class SolutionSet implements Serializable {
  ...
  */
  ...
  public void printArrayBitVectorVariablesToFile(String path) throws JMException{
	    try {
	      FileOutputStream fos   = new FileOutputStream(path)     ;
	      OutputStreamWriter osw = new OutputStreamWriter(fos)    ;
	      BufferedWriter bw      = new BufferedWriter(osw)        ;            
  ...
  public void setEvaluatedSolutions (SolutionSet evaluatedSolutions){
	  evaluatedSolutions_ = evaluatedSolutions;
  }
  public SolutionSet getEvaluatedSolutions (){
	  return evaluatedSolutions_;
  }
  public void setExecutionTime (long runTime){
	  runTime_ = runTime;
  }
