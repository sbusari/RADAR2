...
public class Solution implements Serializable {  
  ...
  private List<Variable[]> arrayBitVariable_ ;
  /**
   * Constructor.
   */
  public Solution() {        
  ...
  public Solution(Problem problem) throws ClassNotFoundException{
    ...
    if(type_.getClass().equals(ArrayBitVectorSolutionType.class)){
    	arrayBitVariable_ = type_.createArrayBitVectorVariables(); 
    }
  } // Solution
  ...
  public Solution(Solution solution) {            
    ...
    if(type_.getClass().equals(ArrayBitVectorSolutionType.class)){
    	arrayBitVariable_ = new ArrayList<Variable []>(); 
  ...
  public List<Variable[]> getArrayBitVectorVariables() {
	    return arrayBitVariable_ ;
  } // getArrayBitVectorVariables
  public void setArrayBitVectorVariables(int i, Variable[] arrayBitVariable ) {
	  arrayBitVariable_.set(i, arrayBitVariable );
  } 
